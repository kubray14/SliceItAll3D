...
public class sliceObj : MonoBehaviour
{
    ...
    [SerializeField] private float sliceForce = 1f;
    ...
    void AddComponent(GameObject obj, int forceDirection)
    {                                                                                         // kesilen objelere hangi komponentleri vermek istiyorsak onlarý eklediðimzi method
        ...
        rigidbody.AddForce(Vector3.right * sliceForce * forceDirection, ForceMode.Impulse);
